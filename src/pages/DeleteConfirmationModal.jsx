...
const DeleteConfirmationModal = ({ placeName, isOpen, onConfirm, onClose }) => {
    const { isLoading } = useTeachingPlacesStore();
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} style={modalStyles} contentLabel="Delete Confirmation Modal">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
                Are you sure you want to delete the teaching place "<strong>{placeName}</strong>"? This action cannot be
                undone.
            </p>
