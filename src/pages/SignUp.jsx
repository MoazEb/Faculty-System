                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6 flex items-center gap-3">
                                ...
                                <label htmlFor="terms" className="text-gray-600 text-sm">
                                    I agree to the {/* <Link to="/terms" className="text-primary hover:underline"> */}
                                    Terms & Conditions
                                    {/* </Link> */}
                                </label>
                            </div>
                            ...
                            <button
                                type="submit"
                                className="w-full p-4 bg-primary text-white rounded-xl font-semibold mb-8 hover:bg-secondary transition-colors shadow-md"
                            >
                                Create account
                            </button>
                        </form>
