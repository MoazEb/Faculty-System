...
import { UploadIcon, CheckSquareIcon, TrashIcon, FloppyDiskIcon } from "@phosphor-icons/react";
    ...
    return (
        <header className="mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                ...
                {/* Connection Status */}
                <div className={`px-3 py-1 rounded-full text-sm font-medium flex items-center ${isConnected ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white rounded-lg shadow dark:bg-secondary-dark">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-2">
                        <div className="flex-grow">
                            <label htmlFor="load-timetable" className="block text-sm font-medium text-gray-600 mb-1 dark:text-primary-light">Select Timetable:</label>
                            <select
                                id="load-timetable"
                            ...
                            >
                                <option value="">{timeTablesList.length === 0 ? "No timetables available" : "Select..."}</option>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-2">
                        <div className="flex-grow">
                            <label htmlFor="save-timetable-name" className="block text-sm font-medium text-gray-600 mb-1 dark:text-primary-light">Timetable Name:</label>
                            <input
                                type="text"
                    ...
                    {timeTableData && <p className="text-xs text-gray-500 dark:text-primary-light">Current timetable in view: <span className="font-medium">{timeTableData.name || "Untitled"}</span></p>}
                </div>
            </div>
