...
const DeleteConfirmationModal = ({ studentName, isOpen, onConfirm, onClose }) => {
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} style={modalStyles} contentLabel="Delete Confirmation Modal">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
                Are you sure you want to delete the student "<strong>{studentName}</strong>"? This action cannot be
                undone.
            </p>
