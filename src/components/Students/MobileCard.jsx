...
export default function MobileCard({ student, handleEdit, handleDelete }) {
    return (
            ...
            <div className="bg-gray-50 dark:bg-secondary-dark px-4 py-3 border-b border-gray-100 dark:border-neutral-600">
                <div className="flex items-center justify-between">
                    <div className="min-w-0 flex-1">
                        ...
                        <span className="text-sm text-gray-500 font-medium dark:text-neutral-400">{student.userName}</span>
                    </div>
                    {/* Actions */}
