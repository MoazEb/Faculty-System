...
const EditStudentModal = ({ student, isOpen, onClose }) => {
    ...
    useEffect(() => {
        if (student) {
            setFormData({
                ...
                gender: typeof student.gender === "number" ? student.gender : 0,
                role: typeof student.role === "number" ? student.role : 2,
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} contentLabel="Edit Student Modal">
            <h2 className="text-2xl font-semibold mb-4 dark:text-primary-light">Edit Student</h2>
