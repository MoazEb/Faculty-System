...
const AddStudentModal = ({ isOpen, onClose, selectedLevel, selectedGender }) => {
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} contentLabel="Add Student Modal">
            <h2 className="text-2xl font-semibold mb-4 dark:text-primary-light">Add Student</h2>
