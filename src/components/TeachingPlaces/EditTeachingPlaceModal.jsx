...
const EditTeachingPlaceModal = ({ staff, isOpen, onClose }) => {
    ...
    const { updateTeachingStaff, isLoading } = useTeachingStaffStore();
    ...
    const handleChange = (e) => {
        ...
        setFormData((prev) => ({
            ...prev,
            [name]: ["gender", "role", "level"].includes(name) ? parseInt(value, 10) : value,
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        await updateTeachingStaff(staff.userName, { ...formData, password: formData.password || undefined });
        onClose();
    };

    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} contentLabel="Edit Teaching Staff Modal">
            <h2 className="text-2xl font-semibold mb-4 dark:text-primary-light">Edit Teaching Staff</h2>
