...
import AddTeachingStaffModal from "./AddTeachingPlaceModal";
import TeachingStaffControls from "./TeachingPlacesControls";
import { useTeachingStaffStore } from "../../stores/useTeachingStaffStore";
import DeleteConfirmationModal from "./DeleteConfirmationModal";
import EditTeachingStaffModal from "./EditTeachingPlaceModal";

export default function ManageTeachingPlaces() {
    const { teachingStaff, isLoading, getTeachingStaff, deleteTeachingStaff, getStaffTypeLabel } =
