...
const DeleteConfirmationModal = ({ staffName, isOpen, onConfirm, onClose }) => {
    const { isLoading } = useTeachingStaffStore();
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={onClose} style={modalStyles} contentLabel="Delete Confirmation Modal">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
                Are you sure you want to delete the staff member "<strong>{staffName}</strong>"? This action cannot be
                undone.
            </p>
